 ...
 */
export function analyzePattern4h(patternArray, liveTrend = null) {
  const inputFile = "btc_4h_analysis.csv";

  if (!fs.existsSync(inputFile)) {
    return { error: "Không tìm thấy file dữ liệu btc_4h_analysis.csv" };
  }
